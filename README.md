...
Предупреждение об экспериментальности показывается не при каждом открытии окна, а не чаще раза в **3 запуска приложения** (флаг «Больше не показывать» отключает его навсегда).
