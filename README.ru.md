...
**[📥 Скачать Github Releases 3 GB → 5.7 GB](https://github.com/DreamSketcher/XTTS-Studio/releases/tag/v1)** · **[🎧 Послушать](#-послушать)** · **[📖 Документация RU](./DOCUMENTATION.RU.md)** · **[📖 Документация EN](./DOCUMENTATION.EN.md)** · **[📜 Лицензия](./LICENSE.md)**
...
✔  C:\XTTS\
✘  C:\Новая папка\XTTS\
XTTS Studio.exe - это конвертированный батник, просто приятный лаунчер для запуска, содержит в себе только пути запуска и иконку.
Включен в обновление на случаай если придется переписать пути запуска.
```
