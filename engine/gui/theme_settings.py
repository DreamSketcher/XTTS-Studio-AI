...
from engine.gui.theme_manager import load_theme, save_theme
from i18n import t
...
def open_theme_customizer(parent):
    ...
    TkLabel(lay_group, text=t("theme_layout_label"), bg=_c("BG_CARD"), fg=_c("TEXT_MAIN"), font=("Segoe UI", 12, "bold")).pack(anchor="w", pady=(0, 10))
