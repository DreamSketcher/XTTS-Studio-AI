...
LANGUAGES = {
    "ru": {
        ...
        "tip_rvc_model": "Список RVC-моделей (.pth) из models/rvc + каталог/поиск voice-models.com.\nЛокальные модели — с 🗑. Из каталога — ⬇ (HF/zip) или 🔗 (открыть страницу).",
    ...
    "en": {
        ...
        "tip_rvc_model": "RVC models (.pth) from models/rvc + voice-models.com catalog/search.\nLocal models — 🗑. Catalog — ⬇ (HF/zip) or 🔗 (open page).",
